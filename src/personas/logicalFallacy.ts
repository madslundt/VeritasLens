...
1. Identify up to TWO logical fallacies in the argument(s), ordered by clarity. Prefer one unless a second is clearly distinct. If no fallacy is found, return a single claim with fallacy "None detected".
